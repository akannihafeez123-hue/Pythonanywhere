...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "approve":
        # ADMIN_ONLY check was missing definition, assuming it's not strictly required or defined elsewhere
        # if ADMIN_ONLY and not is_admin(chat):
        #     await q.message.reply_text("🚫 You’re not authorized to publish tokens."); return
